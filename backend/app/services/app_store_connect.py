...
class AppStoreConnectService:
    ...
    async def validate_receipt(self, receipt_data: str, is_sandbox: bool = False) -> Dict[str, Any]:
    ...
    async def get_subscription_status(self, original_transaction_id: str) -> Dict[str, Any]:
    ...
    async def process_server_notification(self, notification_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if notification_type == "SUBSCRIBED":
                ...
                return {"status": "unknown_notification_type", "type": notification_type}
    ...
    async def _handle_subscription_started(self, notification_data: Dict[str, Any]) -> Dict[str, Any]:
        """Handle new subscription"""
    ...
    async def _handle_subscription_renewed(self, notification_data: Dict[str, Any]) -> Dict[str, Any]:
        """Handle subscription renewal"""
        transaction_info = notification_data.get("data", {}).get("transactionInfo", {})
    ...
    async def _handle_subscription_expired(self, notification_data: Dict[str, Any]) -> Dict[str, Any]:
        """Handle subscription expiry"""
        transaction_info = notification_data.get("data", {}).get("transactionInfo", {})
    ...
    async def _handle_renewal_status_change(self, notification_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def verify_app_store_purchase(self, receipt_data: str, user_id: int) -> Dict[str, Any]:
