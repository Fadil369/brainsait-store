...
async def export_analytics_report(
    report_type: str = Query(..., description="Type of report (revenue, customers, products, payments)"),
    ...
    try:
        ...
        if report_type == "revenue":
            data = await analytics_service.get_revenue_analytics(start_date, end_date, current_user.tenant_id)
        elif report_type == "customers":
            data = await analytics_service.get_customer_analytics(start_date, end_date, current_user.tenant_id)
        elif report_type == "products":
            data = await analytics_service.get_product_analytics(start_date, end_date, current_user.tenant_id)
        elif report_type == "payments":
            data = await analytics_service.get_payment_analytics(start_date, end_date, current_user.tenant_id)
        else:
            raise HTTPException(
...
async def get_real_time_metrics(
    ...
    try:
        ...
        real_time_data = {
            ...
            "revenue_change": today_revenue['total_revenue'] - yesterday_revenue['total_revenue'],
