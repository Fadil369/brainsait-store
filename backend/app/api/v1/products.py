...
from app.core.dependencies import (
    ...
    get_tenant_id, get_language, verify_rate_limit, get_cache, set_cache, delete_cache
)
from app.core.localization import get_localized_field, get_localized_message
from app.models.users import User
from app.models.products import Product, Category, Brand, ProductVariant, ProductReview
from app.schemas.products import (
    ...
    ProductFilters, ProductSort, PaginatedProductsResponse
)
...
async def list_categories(
    ...
    for category in categories:
        ...
        category_dict['children'] = [CategoryResponse.from_orm(child).__dict__ for child in children]
